						...
						<tbody>
							...
							foreach ( $cart_contents as $ticket_type => $ordered_count ) {
								...
								<tr>
									...
									<td class="ticket-type"><?php echo $ticket->details->post_title; ?><input type="hidden" name="ticket_cart_id[]" value="<?php echo (int) $ticket_type; ?>"></td>
			...
			<div class="tickera_additional_info">
				...
				?>>
						 ...
						 foreach ( $cart_contents as $ticket_type => $ordered_count ) {
							 ...
							 $ticket = new TC_Ticket( $ticket_type );
							 ?>
						<h2><?php echo apply_filters( 'tc_checkout_owner_info_ticket_title', $ticket->details->post_title, $ticket_type, $cart_contents, false ); ?></h2>
						<?php
