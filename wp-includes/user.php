...
function wp_update_user($userdata) {
	...
	if ( ! is_wp_error( $user_id ) ) {
		...
		if ( ! empty( $send_password_change_email ) ) {
			...
			$pass_change_text = __( 'Thank you for signing up with us. Please visit ledsymposium2017.dinkevents.com to sign up for the event.

Please contact our site administrator at ledsymposium2017@dink.com.sg if you have any queries.

All at LED Symposium 2017
http://ledsymposium2017.dinkevents.com' );

			$pass_change_email = array(
				'to'      => $user['user_email'],
				'subject' => __( 'LED Symposium 2017 - Thank you for signing up' ),
