<script type="text/javascript">
    jQuery( document ).ready( function ( $ ) {
        ...
        jQuery.validator.addClassRules( "accept_numbers_and_a_z_letters_only", { accept: "^[a-zA-Z0-9]{1,3}$" } );//accept: "/^[a-zA-Z0-9]$/"
			...
			foreach ( $sections as $section ) {
				...
				<div id="<?php echo esc_attr( $section[ 'name' ] ); ?>" class="postbox">
					...
					<div class="inside">
						...
						<div class="description"><?php _e( '<strong>IMPORTANT: </strong> before going to production, if you\'re using bar codes on the tickets, please make sure that your chosen barcode type accepts this kind of formatting.', 'tc' ); ?></div>
					</div>
				</div>
			<?php } ?>
