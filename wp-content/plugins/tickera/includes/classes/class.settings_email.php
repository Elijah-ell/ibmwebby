...
if ( !class_exists( 'TC_Settings_Email' ) ) {
	...
	class TC_Settings_Email {
		...
		function get_settings_email_fields() {
			...
			$default_fields = array_merge( $client_order_placed_email_fields, $client_order_completed_email_fields, $admin_order_completed_email_fields, $admin_order_placed_email_fields, $misc_email_fields );
