...
class tc_checkbox_field_form_element extends TC_Form_Elements {

	var $element_name	 = 'tc_checkbox_field_form_element';
	var $element_title	 = 'Checkbox (Multichoice)';
	var $element_type	 = 'checkbox';

	function on_creation() {
		$this->element_title = apply_filters( 'tc_checkbox_field_form_element_title', __( 'Checkbox (Multichoice)', 'tc' ) );
	}
	...
	function admin_order_details_page_value() {
		$value = array(
			...
			'field_type'		 => 'function',
			'function'			 => 'tc_get_checkbox_admin_order_details_page_value',
			'field_description'	 => '',
	...
	function admin_content() {
		$this->standard_field_name( $this->element_name );
		$this->standard_field_label( $this->element_name );
		//$this->standard_field_placeholder( $this->element_name );
		$this->standard_field_description( $this->element_name );
		$this->standard_field_choice_values( $this->element_name );
		//$this->standard_field_choice_default_values( $this->element_name );
		$this->standard_field_required( $this->element_name );
		$this->standard_field_export( $this->element_name );
...
tc_register_form_element( 'tc_checkbox_field_form_element', __( 'Checkbox (Multichoice)', 'tc' ) );
