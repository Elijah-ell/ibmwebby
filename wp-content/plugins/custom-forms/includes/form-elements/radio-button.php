...
class tc_radio_field_form_element extends TC_Form_Elements {

	var $element_name	 = 'tc_radio_field_form_element';
	var $element_title	 = 'Radio (Single Choice)';
	var $element_type	 = 'radio';

	function on_creation() {
		$this->element_title = apply_filters( 'tc_radio_field_form_element_title', __( 'Radio (Single Choice)', 'tc' ) );
	}
	...
	function admin_order_details_page_value() {
		$value = array(
			...
			'field_type'		 => 'function',
			'function'			 => 'tc_get_radio_admin_order_details_page_value',
			'field_description'	 => '',
...
tc_register_form_element( 'tc_radio_field_form_element', __( 'Radio (Single Choice)', 'tc' ) );
