	...
	class TC_Settings_Serial_Tickets {
		...
		function get_settings_serial_tickets_fields() {
			...
			$fields [] = array(
				...
				'field_title'	 => __( 'Next number of the serial ticket', 'tc' ),
				'field_type'	 => 'option',
				'default_value'	 => '1',
			...
			$fields [] = array(
				...
				'field_title'	 => __( 'Serial ticket code prefix', 'tc' ),
				'field_type'	 => 'option',
				'default_value'	 => '',
			...
			$fields [] = array(
				...
				'field_title'	 => __( 'Serial ticket code suffix', 'tc' ),
				'field_type'	 => 'option',
				'default_value'	 => '',
			...
			$fields [] = array(
				...
				'field_title'	 => __( 'Serial ticket code minimum length', 'tc' ),
				'field_type'	 => 'select',
				'values'		 => array(
					'5'	 => '5',
					'6'	 => '6',
			...
			$fields [] = array(
				...
				'field_title'	 => __( 'Pad character / replace empty character', 'tc' ),
				'field_type'	 => 'option',
				'default_value'	 => '0',
