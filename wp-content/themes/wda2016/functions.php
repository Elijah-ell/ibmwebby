...
<?php if ($comment->comment_approved == '0') : ?>
	<div class="comment-awaiting-moderation"><?php _e('Thank you for your submission, we will post your question and the answer as soon as we check and approve it.') ?></div>
<?php endif; ?>
...
function footer_widgets() {
	...
	register_sidebar( array(
		'name'          => 'Footer Widgets',
		'id'            => 'footer_widgets',
		'before_widget' => '<div class="footer_widget vc_col-sm-6">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>',
	) );
...
function my_login_stylesheet() {
    wp_enqueue_style( 'font', 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,700|Raleway:300,400,700' );
    wp_enqueue_style( 'custom-login', get_stylesheet_directory_uri() . '/css/admin.css' );
    wp_enqueue_style( 'custom-login', get_stylesheet_directory_uri() . '/wp-content/plugins/js_composer/assets/css/js_composer.min.css' );
...
function custom_comment_form($fields) {
    ...
    $fields['title_reply'] = __( '<span>Ask a Question</span>', 'html5blank' ); //Changes The Form Headline
	$fields['label_submit'] = __( 'Submit Question', 'html5blank' ); //Changes The Submit Button Text
