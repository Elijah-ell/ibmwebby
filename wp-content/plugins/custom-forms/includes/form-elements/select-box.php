...
class tc_select_field_form_element extends TC_Form_Elements {

	var $element_name	 = 'tc_select_field_form_element';
	var $element_title	 = 'Select (Dropdown)';
	var $element_type	 = 'select';

	function on_creation() {
		$this->element_title = apply_filters( 'tc_select_field_form_element_title', __( 'Select', 'tc' ) );
	}
	...
	function admin_order_details_page_value() {
		$value = array(
			...
			'field_type'		 => 'function',
			'function'			 => 'tc_get_select_admin_order_details_page_value',
			'field_description'	 => '',
...
tc_register_form_element( 'tc_select_field_form_element', __( 'Select (Dropdown)', 'tc' ) );
